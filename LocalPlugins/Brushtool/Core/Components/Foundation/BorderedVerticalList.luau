...
local BorderedVerticalList = Roact.PureComponent:extend("BorderedVerticalList")

-- Very important note when using this: Do NOT add a direct child that has a
-- non-zero scale component for its Y-Size.
function BorderedVerticalList:init()
	self.listRef = Roact.createRef()
	self.frameRef = Roact.createRef()
end

function BorderedVerticalList:render()
	local children = {}
...
function BorderedVerticalList:didMount()
